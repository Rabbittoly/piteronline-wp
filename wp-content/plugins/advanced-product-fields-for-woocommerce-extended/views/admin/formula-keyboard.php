...
<div class="wapf-fb-keyboard">
    ...
    <div class="wapf-fb-row">
        <div>
            <?php _e('Logical', 'sw-wapf'); ?>
        </div>
        <div>
            <ul>
                <li><button data-type="func" data-symbol="if(">if-else</button></li>
                <li><button data-type="func" data-symbol="and(">and</button></li>
                <li><button data-type="func" data-symbol="or(">or</button></li>
            </ul>
        </div>
    </div>
    <?php  ?>
