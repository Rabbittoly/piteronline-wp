                ...
                if( ! empty( $field['values'] ) ) {
                    ...
                    foreach ( $field['values'] as $idx => $value ) {
                        ...
                        $v = isset( $value['label'] ) ? $value['label'] : $field['raw'];
                                                ...
                                                $price = Fields::do_pricing( $qty_based, $value['price_type'], $value['price'], $base, $quantity, $v, $product_id, $cart_item['wapf'], $cart_item['wapf_field_groups'], $clone_idx, $options_total );
