        ...
        public function register_assets() {
            ...
            $script_vars = [
	            ...
	            'hint'              => Util::pricing_hint_format(),
                        ...
                        $script_vars['date_format'] = get_option('wapf_date_format','mm-dd-yyyy');
            $today_server = \DateTime::createFromFormat( 'D M d Y H:i:s O', current_time('D M d Y H:i:s O') );
            $script_vars['today'] = $today_server->format('Y-m-d\T00:00:00');
