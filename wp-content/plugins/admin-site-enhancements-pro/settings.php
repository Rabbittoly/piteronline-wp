	...
	<div class="wrap asenha">
		...
		<div class="asenha-body">
			...
			<div class="asenha-upgrade-nudge" style="display: none;">
				<div class="asenha-upgrade-nudge__message"><?php echo esc_html__( 'Lifetime Deal (LTD) is available for the Pro version of ASE.', 'admin-site-enhancements' ); ?></div>
					...
					<div class="settings-box half texport-settings">
						...
						<form method="post">
							...
							<p>
								...
								<?php submit_button( __( 'Export ASE Settings', 'admin-site-enhancements' ), 'secondary', 'submit', false); ?>
							</p>
						</form>					
					</div>
...
function asenha_admin_scripts( $hook_suffix ) {
	...
	if ( 'tools_page_email-delivery-log' == $hook_suffix ) {
        ...
        wp_localize_script('asenha-email-delivery-log', 'emailLog',
            array( 
                // 'ajax_url' => admin_url( 'admin-ajax.php' ),
                // 'confirm' => __('Are you sure to delete all?', 'admin-site-enhancements' )
                'nonce'		=> $nonce,
            )
        );
	}
