...
use function foxiz_get_podcast_grid_flex_1;
...
class Podcast_Grid_Flex_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'foxiz-podcast-grid-flex-1';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Podcast Flex Grid', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'Keys include: [category, title, thumbnail, meta, review, excerpt, readmore, divider, player ]', 'foxiz-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_podcast_grid_flex_1' ) ) {
			...
			echo foxiz_get_podcast_grid_flex_1( $settings );
		}
	}
}