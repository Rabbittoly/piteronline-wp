...
use function foxiz_get_hierarchical_3;
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'el_spacing', [
				...
				'selectors'   => [ '{{WRAPPER}} .p-content' => '--el-spacing: {{VALUE}}px;' ],
			]
		);
		$this->add_responsive_control(
			'bottom_margin', [
		...
		$this->add_responsive_control(
			'first_bottom_margin', [
				...
				'selectors'   => [ '{{WRAPPER}} .p-content' => 'margin-bottom: {{VALUE}}px; padding-bottom: {{VALUE}}px' ],
			]
		);
		$this->end_controls_section();
	}
