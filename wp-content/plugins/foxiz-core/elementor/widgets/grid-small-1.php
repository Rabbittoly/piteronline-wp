...
use function foxiz_get_grid_small_1;
...
class Grid_Small_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'foxiz-grid-small-1';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Small Grid', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'featured_width', [
				'label'       => esc_html__( 'Mobile Image Width', 'foxiz-core' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => esc_html__( 'This layout will become a list on the mobiles. Input a custom width for the featured image.', 'foxiz-core' ),
				'placeholder' => '100',
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_grid_small_1' ) ) {

			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();
			echo foxiz_get_grid_small_1( $settings );
		}
	}
}