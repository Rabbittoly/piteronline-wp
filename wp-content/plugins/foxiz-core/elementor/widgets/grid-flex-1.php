...
use function foxiz_get_grid_flex_1;
...
class Grid_Flex_1 extends Widget_Base {
	...
	public function get_name() {
		...
		return 'foxiz-grid-flex-1';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Flex Grid 1', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => esc_html__( 'Keys include: [title, thumbnail, meta, review, excerpt, readmore, divider, images]', 'foxiz-core' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'options'     => Options::flex_review_dropdown(),
				'default'     => '0',
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_grid_flex_1' ) ) {
			...
			echo foxiz_get_grid_flex_1( $settings );
		}
	}
}