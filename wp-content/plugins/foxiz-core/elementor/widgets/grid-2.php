...
use function foxiz_get_grid_2;
use function foxiz_is_ruby_template;

class Grid_2 extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Foxiz - Grid 2', 'foxiz-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_grid_2' ) ) {

			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();
			echo foxiz_get_grid_2( $settings );
		}
	}
}