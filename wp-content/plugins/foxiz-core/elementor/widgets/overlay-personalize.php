...
use function foxiz_get_overlay_personalize;
...
class Overlay_Personalize extends Widget_Base {
	...
	public function get_name() {
		...
		return 'foxiz-overlay-personalize';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Personalized Overlay', 'foxiz-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_overlay_personalize' ) ) {
			...
			echo foxiz_get_overlay_personalize( $settings );
		}
	}
}