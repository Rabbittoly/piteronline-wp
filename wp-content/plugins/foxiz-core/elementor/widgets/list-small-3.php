...
use function foxiz_get_list_small_3;
 ...
 */
class List_Small_3 extends Widget_Base {

	public function get_name() {

		return 'foxiz-list-small-3';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Small List 3', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'featured_width', [
				...
				'selectors'   => [
					'{{WRAPPER}} .p-list-small-3 .feat-holder' => 'width: {{VALUE}}px',
				],
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_list_small_3' ) ) {
			...
			echo foxiz_get_list_small_3( $settings );
		}
	}
}