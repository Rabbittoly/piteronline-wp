...
class Image extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Foxiz - Image', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw'             => esc_html__( 'Dark mode image will not show in the light box if it is enabled.', 'foxiz' ),
		...
		$this->add_control(
			'caption_source',
			[
				'label'   => esc_html__( 'Caption', 'foxiz-core' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'none'       => esc_html__( 'None', 'foxiz-core' ),
					'attachment' => esc_html__( 'Attachment Caption', 'foxiz-core' ),
					'custom'     => esc_html__( 'Custom Caption', 'foxiz-core' ),
				],
				'default' => 'none',
			]
		);
		...
		$this->add_control(
			'caption',
			[
				'label'       => esc_html__( 'Custom Caption', 'foxiz-core' ),
				'type'        => Controls_Manager::TEXT,
				'ai'          => [ 'active' => false ],
				'default'     => '',
				'placeholder' => esc_html__( 'Enter image caption text...', 'foxiz-core' ),
				'condition'   => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'none'   => esc_html__( 'None', 'foxiz-core' ),
					'file'   => esc_html__( 'Media File', 'foxiz-core' ),
					'custom' => esc_html__( 'Custom URL', 'foxiz-core' ),
				],
			]
		);
		...
		$this->add_control(
			'open_lightbox',
			[
				'label'     => esc_html__( 'Lightbox', 'foxiz-core' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'default',
				'options'   => [
					'default' => esc_html__( '- Default -', 'foxiz-core' ),
					'yes'     => esc_html__( 'Yes', 'foxiz-core' ),
					'no'      => esc_html__( 'No', 'foxiz-core' ),
				],
				'condition' => [
					'link_to' => 'file',
				],
		...
		$this->add_control(
			'view',
			[
				'label'   => esc_html__( 'View', 'foxiz-core' ),
		...
		$this->add_responsive_control(
			'object-fit',
			[
				'label'     => esc_html__( 'Object Fit', 'foxiz-core' ),
				'type'      => Controls_Manager::SELECT,
				'condition' => [
					'height[size]!' => '',
				],
				'options'   => [
					...
					'fill'    => esc_html__( 'Fill', 'foxiz-core' ),
					'cover'   => esc_html__( 'Cover', 'foxiz-core' ),
					'contain' => esc_html__( 'Contain', 'foxiz-core' ),
				],
				'default'   => '',
				'selectors' => [
	...
	<?php endif;
		if ( $has_caption ) : ?>
			<figcaption class="widget-image-caption wp-caption-text"><?php
				echo foxiz_strip_tags( $this->get_caption( $settings ) );
				?></figcaption>
		<?php endif;
		if ( $has_caption ) : ?>
			</figure>
