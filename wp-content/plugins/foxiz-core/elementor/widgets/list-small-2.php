...
use function foxiz_get_list_small_2;
 ...
 */
class List_Small_2 extends Widget_Base {

	public function get_name() {

		return 'foxiz-list-small-2';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Small List 2', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'featured_width', [
				...
				'selectors'   => [
					'{{WRAPPER}} .p-list-small-2 .feat-holder' => 'width: {{VALUE}}px',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'feat_spacing', [
				...
				'selectors'   => [ '{{WRAPPER}} .p-wrap' => '--featured-spacing: {{VALUE}}px;' ],
			]
		);
		$this->add_control(
			'box_border',
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_list_small_2' ) ) {
			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();

			echo foxiz_get_list_small_2( $settings );
		}
	}
}