...
use function foxiz_get_list_box_1;
 ...
 */
class List_Box_1 extends Widget_Base {

	public function get_name() {

		return 'foxiz-list-box-1';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Boxed List 1', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'featured_width', [
				...
				'selectors'   => [
					'{{WRAPPER}} .p-list-box-1 .list-feat-holder' => 'width: {{VALUE}}px; max-width: {{VALUE}}px;',
				],
			]
		);
		$this->add_control(
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_list_box_1' ) ) {
			...
			echo foxiz_get_list_box_1( $settings );
		}
	}
}