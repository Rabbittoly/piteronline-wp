...
use function foxiz_get_categories_3;

/**
 * Class Categories_List_3
 *
 * @package foxizElementor\Widgets
 */
class Categories_List_3 extends Widget_Base {

	public function get_name() {

		return 'foxiz-categories-3';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Taxonomies List 3', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'description',
			[
				'label'       => esc_html__( 'Category Description', 'foxiz-core' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => Options::switch_dropdown( false ),
				'description' => esc_html__( 'Enable or disable the category description.', 'foxiz-core' ),
				'default'     => '1',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .cbox-description',
			]
		);
		$this->add_control(
			'count_posts',
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_categories_3' ) ) {
			...
			echo foxiz_get_categories_3( $settings );
		}
	}
}