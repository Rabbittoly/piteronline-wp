...
use function foxiz_get_grid_box_1;
use function foxiz_is_ruby_template;

class Grid_Box_1 extends Widget_Base {

	public function get_name() {

		return 'foxiz-grid-box-1';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Boxed Grid 1', 'foxiz-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_grid_box_1' ) ) {

			$settings         = $this->get_settings();
			$settings['uuid'] = 'uid_' . $this->get_id();
			echo foxiz_get_grid_box_1( $settings );
		}
	}
}