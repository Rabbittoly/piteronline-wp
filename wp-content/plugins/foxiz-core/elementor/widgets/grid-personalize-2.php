...
use function foxiz_get_grid_personalize_2;

class Grid_Personalize_2 extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Foxiz - Personalized Grid 2', 'foxiz-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_grid_personalize_2' ) ) {
			...
			echo foxiz_get_grid_personalize_2( $settings );
		}
	}
