...
use function foxiz_get_hierarchical_1;
use function foxiz_is_ruby_template;

class Hierarchical_1 extends Widget_Base {

	public function get_name() {

		return 'foxiz-hierarchical-1';
	}

	public function get_title() {

		return esc_html__( 'Foxiz - Hierarchical 1', 'foxiz-core' );
	}
	...
	protected function render() {
		...
		if ( function_exists( 'foxiz_get_hierarchical_1' ) ) {
			...
			echo foxiz_get_hierarchical_1( $settings );
		}
	}
}