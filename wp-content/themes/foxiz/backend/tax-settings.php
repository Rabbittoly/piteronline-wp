	...
	function foxiz_get_category_config() {
		...
		return [
			...
			'fields'     => [
				...
				[
					'id'   => 'blog_info',
					'name' => esc_html__( 'Post Listing - Heading', 'foxiz' ),
					'tab'  => 'default-blog',
					'type' => 'info',
				],
				[
				...
				[
					...
					'info'    => esc_html__( 'This setting will be not available if you use "Use Ruby Template for the Post Listing" to build the blog listing.', 'foxiz' ),
					'tab'     => 'default-blog',
					'type'    => 'select',
...
if ( ! function_exists( 'foxiz_register_default_term_settings' ) ) {
	function foxiz_register_default_term_settings() {
		...
		return [
			...
			'info'   => esc_html__( 'The settings will apply to this taxonomy only, and the ones below will take priority over other settings in the "Theme Options > Archives" settings. The styling setting will only be available if you display the listing via Foxiz Elementor blocks such as: Grid, List, and Flex block.', 'foxiz' ),
			'id'     => 'foxiz_category_meta',
			'tabs'   => [
				[
