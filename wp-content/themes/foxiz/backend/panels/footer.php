		...
		return [
			...
			'fields' => [
				...
				[
					'id'       => 'footer_layout',
					'type'     => 'select',
					'title'    => esc_html__( 'Footer Layout', 'foxiz' ),
				...
				[
					...
					'description' => esc_html__( 'NOTE: Select "Use Ruby Template" in the "Footer Layout" setting if you are using the Ruby Template shortcode.', 'foxiz' ),
					'rows'        => 2,
					'default'     => '',
				],
				[
