		...
		return [
			...
			'fields'     => [
				...
				[
					...
					'subtitle' => esc_html__( 'Display the the follow button in the header of the category pages.', 'foxiz' ),
					'default'  => false,
				],
				[
				...
				[
					...
					'subtitle' => esc_html__( 'Display the the follow button in the header of the author pages.', 'foxiz' ),
					'default'  => false,
				],
				[
		...
		return [
			...
			'fields'     => [
				...
				[
					...
					'notice' => [
						esc_html__( 'These settings will only take effect if you select the Predefined layout for displaying the global post listing.', 'foxiz' ),
				...
				[
					...
					'subtitle'    => esc_html__( 'Select entry meta you would like to hide on mobile devices. In case long meta it would be useful.', 'foxiz' ),
		...
		return [
			...
			'fields'     => [
				...
				[
					...
					'description' => esc_html__( 'You can use Elementor to build this page.', 'foxiz' ),
					'default'     => '#',
				],
				[
					'id'       => $prefix . 'pattern',
		...
		return [
			...
			'fields'     => [
				...
				[
					...
					'default'  => esc_html__( 'No Read History', 'foxiz' ),
				],
				[
