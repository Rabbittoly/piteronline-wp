	...
	function foxiz_header_user( $settings = [] ) {
		...
		<div class="wnav-holder widget-h-login header-dropdown-outer">
			...
			<?php else : ?><?php if ( empty( $settings['header_login_layout'] ) ) : ?>
				<a href="<?php echo wp_login_url( $login_redirect ); ?>" class="login-toggle is-login header-element" data-title="<?php echo esc_attr( $login_label ); ?>" aria-label="<?php echo esc_attr( $login_label ); ?>"><?php
			...
			<?php elseif ( '1' === $settings['header_login_layout'] ) : ?>
				<a href="<?php echo wp_login_url( $login_redirect ); ?>" class="login-toggle is-login is-btn header-element" aria-label="<?php echo esc_attr( $login_label ); ?>"><span><?php foxiz_render_inline_html( $login_label ); ?></span></a>
			<?php else : ?>
				<a href="<?php echo wp_login_url( $login_redirect ); ?>" class="login-toggle is-login is-btn is-btn-icon header-element" aria-label="<?php echo esc_attr( $login_label ); ?>"><?php
					if ( ! empty( $settings['login_icon'] ) ) {
						echo '<span class="login-icon-svg"></span>';
					} else {
						echo '<i class="rbi rbi-user wnav-icon"></i>';
